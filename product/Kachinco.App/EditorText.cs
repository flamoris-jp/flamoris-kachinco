...
internal static class EditorText
{
    ...
    public static string ImportGuidance => Choose("MOV / MP4 / WAV / MP3 / M4Aを読み込んで始めましょう。保存済みのプロジェクトも開けます。", "Import MOV / MP4 / WAV / MP3 / M4A to start, or open a saved project.");
